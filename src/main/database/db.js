...
db.serialize(() => {
  ...
  `,
        (err) => {
            if (err)
                console.error(
                    'Error creating note search FTS table:',
                    err.message,
                );
  ...
  `,
        (err) => {
            if (err)
                console.error('Error creating vector_sync table:', err.message);
  ...
  `,
        (err) => {
            if (err)
                console.error(
                    'Error creating chat conversations table:',
                    err.message,
                );
  ...
  `,
        (err) => {
            if (err)
                console.error(
                    'Error creating chat messages table:',
                    err.message,
                );
