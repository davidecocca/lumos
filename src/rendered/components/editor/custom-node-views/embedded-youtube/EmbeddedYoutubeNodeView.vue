...
const aspectRatio = computed(() => {
    const width = toWidthNumber(props.node.attrs.width) || toWidthNumber(configuredWidth.value)
    const height = toWidthNumber(props.node.attrs.height) || toWidthNumber(configuredHeight.value)
...
const stopResize = async () => {
    ...
    if (nextWidth && (nextWidth !== previousWidth || nextHeight !== previousHeight)) {
