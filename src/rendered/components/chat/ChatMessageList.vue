<template>
    ...
    >
        <div v-if="isEmpty" class="w-100">
            <EmptyChatState />
        </div>

        <div v-if="!isEmpty" ref="chatContainer" class="chat-container">
            <v-list lines="one" style="background-color: transparent">
                ...
                >
                    <div
                        ...
                        class="d-flex flex-grow-1 justify-start align-items-center"
                        style="max-width: 80%"
                    >
                        <ChatCard
                            class="flex-grow-1"
                    ...
                    <div
                        ...
                        class="d-flex justify-end flex-grow-1"
                    >
                        <ChatCard
                            :message="message"
                            :showSources="showSources"
