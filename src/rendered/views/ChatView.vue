    ...
    <v-layout class="chat-view">
        ...
        >
            <v-list nav density="compact">
                <v-list-item>
                    <v-list-item-title
                        class="text-medium-emphasis text-body-small"
                    >
                        Recents
                    </v-list-item-title>
                ...
                <v-list nav density="compact" class="chat-view__list px-2">
                    ...
                    >
                        ...
                        <template v-slot:append>
                            <v-menu
                                :model-value="
                                    activeConversationMenuId === conversation.id
                                "
                                @update:model-value="
                            ...
                            >
                                ...
                                >
                                    <v-list-item
                                        @click.stop="
                                            openRenameChatDialog(conversation)
                                        "
                                        rounded="lg"
                                    >
                                        <template v-slot:append>
                                    ...
                                    <v-list-item
                                        ...
                                        base-color="error"
                                        @click.stop="
                                            openDeleteChatDialog(conversation)
                                        "
                                        rounded="lg"
                                    >
                                        <template v-slot:append>
...
const isConversationActionVisible = (conversationId) => {
    return (
        ...
        activeConversationMenuId.value === conversationId
    );
};
