    ...
    <div v-if="editor">
        ...
        <div class="d-flex flex-row align-center justify-center bubble-menu-row">
            <div class="flex-grow-1 bubble-menu-action" style="flex-basis: 0;">
                ...
                <v-list density="compact" rounded="lg" class="pl-1 pr-1 pt-2 pb-2 bg-surface-dark">
                    <v-list-subheader>Turn into</v-list-subheader>
                    <!-- Paragraph -->
                    <v-list-item @click="editor.commands.setParagraph()" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Heading 1 -->
                    <v-list-item @click="editor.commands.toggleHeading({ level: 1 })" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Heading 2 -->
                    <v-list-item @click="editor.commands.toggleHeading({ level: 2 })" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Heading 3 -->
                    <v-list-item @click="editor.commands.toggleHeading({ level: 3 })" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Bullet list -->
                    <v-list-item @click="editor.commands.toggleBulletList()" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Numbered list -->
                    <v-list-item @click="editor.commands.toggleOrderedList()" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Task list -->
                    <v-list-item @click="editor.commands.toggleTaskList()" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Blockquote -->
                    <v-list-item @click="editor.commands.toggleBlockquote()" rounded="lg">
                        <template v-slot:prepend>
                    ...
                    <!-- Code block -->
                    <v-list-item @click="editor.commands.toggleCodeBlock()" rounded="lg">
                        <template v-slot:prepend>
                            <v-icon icon="ph-code"></v-icon>
                        </template>
                        <v-list-item-title>Code block</v-list-item-title>
                    </v-list-item>
                    <v-list-item @click="insertDetails()" rounded="lg">
                        <template v-slot:prepend>
                            <v-icon icon="ph-caret-right"></v-icon>
                        </template>
                        <v-list-item-title>Details</v-list-item-title>
                    </v-list-item>
                    <v-list-item v-if="canRemoveDetails()" @click="removeDetails()" rounded="lg">
                        <template v-slot:prepend>
...
<!-- Divider before the AI quick functions row -->
<v-divider class="mt-1 mb-1"></v-divider>
...
<div class="d-flex flex-row align-center justify-center ai-actions bubble-menu-row">
    <div class="flex-grow-1 bubble-menu-action" style="flex-basis: 0;">
        <v-tooltip text="Edit with AI" location="bottom">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" class="w-100 bubble-menu-btn" @click="aiEdit" variant="text" prepend-icon="ph-pencil-simple" rounded="lg" density="compact">Edit</v-btn>
            </template>
        </v-tooltip>
    </div>
    <v-divider vertical class="mx-2"></v-divider>
    <div class="flex-grow-1 bubble-menu-action" style="flex-basis: 0;">
        <v-tooltip text="Fix spelling & grammar" location="bottom">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" class="w-100 bubble-menu-btn" @click="aiFixGrammar()" variant="text" prepend-icon="ph-text-aa" rounded="lg" density="compact">Fix</v-btn>
            </template>
        </v-tooltip>
    </div>
    <v-divider vertical class="mx-2"></v-divider>
    <div class="flex-grow-1 bubble-menu-action" style="flex-basis: 0;">
        <v-tooltip text="Format text with AI" location="bottom">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" class="w-100 bubble-menu-btn" @click="aiFormatText()" variant="text" prepend-icon="ph-text-t" rounded="lg" density="compact">Format</v-btn>
            </template>
        </v-tooltip>
    </div>
    <v-divider vertical class="mx-2"></v-divider>
        ...
        <v-menu>
            ...
            <v-list density="compact" rounded="lg" class="pl-1 pr-1 pt-2 pb-2 bg-surface-dark">
                ...
                <v-menu open-on-hover location="end" offset="-10">
                    ...
                    <v-list density="compact" style="min-width: 180px;" rounded="lg" class="pl-1 pr-1 pt-2 pb-2 bg-surface-dark">
                        <v-list-item v-for="tone in supportedTones" :key="tone.key" @click="aiChangeTone(tone.key)" rounded="lg">
                            <template v-slot:prepend>
                ...
                <v-menu open-on-hover location="end" offset="-10">
                    ...
                    <v-list density="compact" style="min-width: 160px;" rounded="lg" class="pl-1 pr-1 pt-2 pb-2 bg-surface-dark">
                        <v-list-item v-for="lang in supportedLanguages" :key="lang.key" @click="aiTranslateTo(lang.key)" rounded="lg">
                            <v-list-item-title>
...
.editor-layout {
    display: flex;
    height: calc(100vh - 170px); /* Adjust based on your header height */
    position: relative;
}
